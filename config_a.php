...
<head>
    <meta charset="utf-8" />
    <title>Configurações • GYMANAGER</title>
...
<body>
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" style="width: 300px!important;" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body mt-5">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item">
            <a class="nav-link font-itens active mt-3" href="config_a.php"><i class="fa-solid fa-gear"></i> Configurações</a>
          </li>
      </div>
    </div>
  </nav>
    ...
    <div class="container my-5">
        <div class="row">
            ...
            <div class="col-md-12">
                <h3 class="main-title">Configurações</h3>
            </div>
        </div>
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-5 text-center">
                <img src="<?php echo $_SESSION['perfil']; ?>" class="person-config mb-5">
                <form method="POST" enctype="multipart/form-data" action="alterarfoto.php">

                    <div class="form-group">
                        <label for="arquivo">
                            <p class="form-config">Alterar foto de perfil <i class="fa-regular fa-image"></i></p>
                        </label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-itens" name="usuario" value="<?php echo $_SESSION['UsuarioUsuario']; ?>" />
                    </div>
                    <button class="mt-4 avalia" type="submit">Cadastrar</button>
                </form>
            </div>
