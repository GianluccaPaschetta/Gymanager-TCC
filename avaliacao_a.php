...
$botao2 = '<a href="serie.php" class="avalia">Séries</a>';
//conexaoid
...
$sql = "SELECT ava_id, ava_nome, ava_data FROM avaliacao WHERE avaliacao.aluno_id = '$aluno_id'";
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" style="width: 300px!important;" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body mt-5">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item">
            <a class="nav-link font-itens active mt-3" href="avaliacao_a.php"><i class="fa-solid fa-list-check"></i> Avaliação</a>
          </li>
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-xs-12">
        ...
        while ($r = mysqli_fetch_array($consulta)) {
          ...
          $table .= '<td><form action="abriravaliacao_a.php" method="post">';
          ...
          $table .= '<td><form action="removeravaliacao_a.php" method="post">';
          $table .= '<input type="hidden" name="idAva" value="' . $r[$campo[1]] . '">';
