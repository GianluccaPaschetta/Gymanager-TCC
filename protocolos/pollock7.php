...
<head>
    ...
    <title>Pollock7 • GYMANAGER</title>
    <!-- Fonte -->
    ...
    <div class="d-flex justify-content-center">
        <div class="card" style="margin-top: 2%; margin-bottom: 2%;">
            ...
            <form method="POST" action="processa_prot.php">
                ...
                <h3 class="titulo">Pollock7:</h3>
                <div class="card-body">
                    <div class="form-group">
                        <input type="hidden" name="nome" class="form-control form-itens " value="Pollock7" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" name="peito" class="form-control form-itens" placeholder="Peito" required>
                    </div>
                    <div class="form-group">
                        <input type="text" name="triceps" class="form-control form-itens" placeholder="Tríceps" required>
                    </div>

                    <div class="form-group">
                        <input type="text" name="axilarmedio" class="form-control form-itens" placeholder="Axilar médio" required>
                    </div>
                    ...
                    <div class="form-group">
                        <input type="text" name="subescapular" class="form-control form-itens" placeholder="Subescapular" required>
                    </div>

                    <div class="form-group">
                        <input type="text" name="suprailiaca" class="form-control form-itens" placeholder="Suprailíaca" required>
                    </div>
