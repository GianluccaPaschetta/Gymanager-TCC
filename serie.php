...
$sql = "SELECT serie_id, serie_nome, serie_data FROM serie WHERE serie.conexao_id = '$conexaoid'";
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-xs-12">
                ...
                while ($r = mysqli_fetch_array($consulta)) {
                    ...
                    $table .= '<td><form action="abrirserie.php" method="post">';
                    ...
                    $table .= '<td><form action="removerserie.php" method="post">';
                    $table .= '<input type="hidden" name="idSerie" value="' . $r[$campo[1]] . '">';
                ...
                <a href="addserie.php" class="avalia mt-3">Adicionar Série <i class="fa-solid fa-plus"></i></a>
                </div>
                ';
